...
namespace CCAS.BlazorServer.Pages.Subjects;

public partial class SubjectAssessmentsGrid : Microsoft.AspNetCore.Components.ComponentBase
{
    private CustomValidation? _customValidation;
    public SfGrid<SubjectVM>? Grid { get; set; }
    public SfGrid<AssessmentVM>? Grid2 { get; set; }
