...
namespace CCAS.BlazorOldServer.Pages.AssessmentMarks;

public partial class AssessmentMarksGrid : Microsoft.AspNetCore.Components.ComponentBase
{
    private CustomValidation? _customValidation;
    public SfGrid<AssessmentMarkVM>? Grid { get; set; }
    public AssessmentMarkVM? SelectedData;
    ...
    public void RowSelectHandler(RowSelectEventArgs<AssessmentMarkVM> Args)
    {
        SelectedData = Args.Data;
    }


    public async Task OnActionBegin(ActionEventArgs<AssessmentMarkVM> Args)
    {
    ...
    {
        if (args.Item.Id == "AssessmentMarksGrid_pdfexport")  //Id is combination of Grid's ID and itemname
        {
            await Grid!.PdfExport();
        }
        if (args.Item.Id == "AssessmentMarksGrid_excelexport") //Id is combination of Grid's ID and itemname
        {
            await Grid!.ExcelExport();
        }
        if (args.Item.Id == "AssessmentMarksGrid_csvexport") //Id is combination of Grid's ID and itemname
        {
